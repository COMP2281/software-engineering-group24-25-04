...
| ----- | ----- | ----- | ----- | ----- |
| | | Low | Medium | High |
| | Rare | Client uses a commercial option | No response from client* | Data security breach* |
| Probability | Possible | | Someone won't/can't do project | |
| | Likely | | New updates on frameworks causing bugs | Work lost/Out of sync upates |
